...
- `detail` `service` - Penetration Testing: https://www.sophos.com/en-gb/services/advisory-services/penetration-testing
- `detail` `service` - AI speed. Human judgment.: https://www.sophos.com/en-gb/services/managed-detection-and-response
- `detail` `service` - Expert-led threat detection and response for Microsoft environments: https://www.sophos.com/en-gb/services/managed-detection-and-response/microsoft
...
- `detail` `solution_compliance` - Sophos supports efforts to comply with the CCPA: https://www.sophos.com/en-gb/solutions/compliance/ccpa
- `detail` `solution_compliance` - Easily comply with CIPA requirements with help from Sophos: https://www.sophos.com/en-gb/solutions/compliance/cipa
- `detail` `solution_compliance` - CIS Critical Security Controls are essential for your security: https://www.sophos.com/en-gb/solutions/compliance/cis-critical-security-controls
- `detail` `solution_compliance` - Get help with the EU General Data Protection Regulation (GDPR): https://www.sophos.com/en-gb/solutions/compliance/gdpr
- `detail` `solution_compliance` - Sophos supports your efforts to fast-track HIPAA compliance: https://www.sophos.com/en-gb/solutions/compliance/hipaa
- `detail` `solution_compliance` - PCI DSS compliance can be a challenge: https://www.sophos.com/en-gb/solutions/compliance/pci-dss
- `detail` `solution_compliance` - SOX compliance is important for your financial data security: https://www.sophos.com/en-gb/solutions/compliance/sox

## solutions/industries (8 detail pages)

- `detail` `solution_industry` - Cybersecurity as a service for Education: https://www.sophos.com/en-gb/solutions/industries/education
- `detail` `solution_industry` - Sophos Protected Classroom: https://www.sophos.com/en-gb/solutions/industries/education1
- `detail` `solution_industry` - Trust Sophos to Secure Your Financial Data, Transactions, and Operations: https://www.sophos.com/en-gb/solutions/industries/finance-and-banking
- `detail` `solution_industry` - Trust Sophos Cybersecurity for Uninterrupted Delivery of Essential Services by Government Agencies: https://www.sophos.com/en-gb/solutions/industries/government
- `detail` `solution_industry` - Trusted cybersecurity for NHS: https://www.sophos.com/en-gb/solutions/industries/healthcare
- `detail` `solution_industry` - The World's Most Trusted Cybersecurity for Modern Manufacturing: https://www.sophos.com/en-gb/solutions/industries/manufacturing
